...
def start_training(char_name: str, char_class: str) -> str:
    """В зависимости от класса персонажа печатает приветствие.
    Реализует сценарий тренировки,
    атрибуты зависят от выбранного класса персонажа.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функционал выбора класса.
    в зависимости от выбора - отдельное приветствие.
    """
    approve_choice: str = ''
    char_class: str = ''
